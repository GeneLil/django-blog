...
class PostViewTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        user.set_password('12345')
        user.save()
        post1 = Post.objects.create(pk=1, title='post1', body='blah blah blah', author_id=1, image=post_image)
        post2 = Post.objects.create(pk=2, title='post2', body='blah blah blah', author_id=2, image=post_image)
        post3 = Post.objects.create(pk=3, title='post3', body='blah blah blah', author_id=1, image=post_image)
